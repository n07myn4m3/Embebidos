...
#define PSRAM_BASE_ADDRESS         (0x63000000)      //NCS3 Direccion fpga o chipselect3

/** 8-bits Data bus on EBI */ //ESto es para la memoria ram? mascara, puertoc
...
/** Address Bus A0-A13 */
#define PIN_ADDR_BUS_ON_EBI         {0xfffc0000, PIOC, ID_PIOC, PIO_PERIPH_A, PIO_PULLUP} //18 a 31 del puerto c, puerto de datos
