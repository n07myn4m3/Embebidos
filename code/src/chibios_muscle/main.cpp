...
int main(void) {
 ...
 while(true) {
    //El objetivo es acumular todos los datos en un unico vector que sera luego interpretado por python
  
    //chprintf((BaseChannel *) &SD2, "Verificar los datos ---------\r\n");
    //chprintf((BaseChannel *)&SD2, "hello %d, \r\n", ADC_Val*3300/4096) ;
    //Si le pido hacer esto se cuelga
    //chprintf((BaseChannel *)&SD2, "Angle X %d, Angle Y %d, ADC %d, \r\n", Angle[0], Angle[1], ADC_Val*3300/4096) ;
    //Por el momento solo le pido hacer esto
    chprintf((BaseChannel *)&SD2, "Angle X %d, Angle Y %d, ADC %d, \r\n", 1, 1, ADC_Val*3300/4096);
  }
